		...
		<div class="header-logo">
			<p>
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<img decoding="async" class="alignnone size-full wp-image-81 site-logo-img" src="<?php echo esc_url( $logo_url ); ?>" alt="VINACOS" style="height: 68px; width: auto; max-height: 78px; object-fit: contain;" />
				</a>
			</p>
		</div>
