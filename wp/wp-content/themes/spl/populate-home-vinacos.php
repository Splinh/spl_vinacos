	...
	array(
		...
		'items'         => array(
			array(
				...
				'btn_text'    => 'Xem thêm',
				'btn_link'    => '#skincare',
				'image'       => get_template_directory_uri() . '/static/img/products/product1.jpg',
			),
			array(
				...
				'btn_text'    => 'Xem thêm',
				'btn_link'    => '#clay-mask',
				'image'       => get_template_directory_uri() . '/static/img/products/product2.jpg',
			),
			array(
				...
				'btn_text'    => 'Xem thêm',
				'btn_link'    => '#scrub',
				'image'       => get_template_directory_uri() . '/static/img/products/product3.jpg',
			),
			array(
				...
				'image'       => get_template_directory_uri() . '/static/img/products/product4.jpg',
			),
		),
	),
