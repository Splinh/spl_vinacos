...
$stats = [
	[
		...
		'svg'    => '<svg class="w-12 h-12 text-[#1e60a3]" viewBox="0 0 48 48" fill="none" stroke="#1e60a3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="10" y="8" width="28" height="20" rx="3" fill="#f0f7ff"/><line x1="15" y1="14" x2="27" y2="14"/><line x1="15" y1="18" x2="23" y2="18"/><circle cx="30" cy="30" r="7" fill="#ffffff"/><path d="M30 25l1.5 3 3.5.5-2.5 2.5.6 3.5-3.1-1.6-3.1 1.6.6-3.5-2.5-2.5 3.5-.5z"/><path d="M26 36l-3 7 4-2 4 2-3-7"/></svg>',
	],
	[
		'number' => '100%',
		'desc'   => 'Kiểm nghiệm công thức và test độ ổn định',
		'svg'    => '<svg class="w-12 h-12 text-[#1e60a3]" viewBox="0 0 48 48" fill="none" stroke="#1e60a3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="24" r="18" stroke-dasharray="3 3" stroke-opacity="0.5"/><path d="M16 28h5l3-3 4 4 4-2"/><path d="M28 16v5l-3 3 4 4-2 4"/><path d="M16 20h8l-2 5 5 2"/><path d="M18 16l6 6M24 30l6-6M30 18l-6 6"/></svg>',
	],
	[
		'number' => '30+',
		'desc'   => 'Đề tài nghiên cứu khoa học đã đăng tải',
		'svg'    => '<svg class="w-12 h-12 text-[#1e60a3]" viewBox="0 0 48 48" fill="none" stroke="#1e60a3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="12" y="10" width="24" height="32" rx="3" fill="#f0f7ff"/><path d="M18 10V7a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v3"/><path d="M22 18v5M20 23h4M24 28a4 4 0 1 0 4-4h-4"/><path d="M18 36h12"/><circle cx="22" cy="18" r="2"/></svg>',
	],
	[
		'number' => '3+',
		'desc'   => 'Bằng sáng chế & giải pháp hữu ích',
		'svg'    => '<svg class="w-12 h-12 text-[#1e60a3]" viewBox="0 0 48 48" fill="none" stroke="#1e60a3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="20" cy="16" r="6"/><path d="M10 36c0-6 4.5-10 10-10 2 0 3.8.6 5.2 1.6"/><circle cx="32" cy="32" r="7" stroke-dasharray="3 2"/><path d="M28 26l8-8M36 22v-4h-4"/></svg>',
	],
];
...
$promises = [
	[
		...
		'svg'   => '<svg class="w-16 h-16 text-[#1e60a3]" viewBox="0 0 64 64" fill="none" stroke="#1e60a3" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="10" y="12" width="44" height="32" rx="2"/><circle cx="42" cy="38" r="8" fill="#ffffff"/><path d="M42 33l1.8 3.5 3.9.6-2.8 2.7.7 3.8-3.6-1.9-3.6 1.9.7-3.8-2.8-2.7 3.9-.6z"/><path d="M38 45l-3 7 5-2.5 5 2.5-3-7"/></svg>',
	],
	[
		...
		'svg'   => '<svg class="w-16 h-16 text-[#1e60a3]" viewBox="0 0 64 64" fill="none" stroke="#1e60a3" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="10" y="20" width="44" height="30" rx="3"/><path d="M24 20v-5a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v5"/><line x1="10" y1="32" x2="54" y2="32"/><rect x="20" y="29" width="6" height="6" rx="1" fill="#ffffff"/><rect x="38" y="29" width="6" height="6" rx="1" fill="#ffffff"/></svg>',
	],
	[
		'title' => 'Sự minh bạch',
		...
		'svg'   => '<svg class="w-16 h-16 text-[#1e60a3]" viewBox="0 0 64 64" fill="none" stroke="#1e60a3" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="20" y="10" width="30" height="40" rx="2"/><line x1="26" y1="18" x2="42" y2="18"/><line x1="26" y1="24" x2="42" y2="24"/><line x1="26" y1="30" x2="36" y2="30"/><line x1="26" y1="36" x2="34" y2="36"/><circle cx="24" cy="34" r="10" fill="#ffffff"/><line x1="17" y1="41" x2="11" y2="47" stroke-width="3"/><line x1="20" y1="34" x2="28" y2="34"/><line x1="24" y1="30" x2="24" y2="38"/></svg>',
	],
	[
		...
		'svg'   => '<svg class="w-16 h-16 text-[#1e60a3]" viewBox="0 0 64 64" fill="none" stroke="#1e60a3" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="32" cy="22" r="8"/><path d="M16 46c0-9 7.2-16 16-16s16 7.2 16 16v4H16v-4z"/></svg>',
	],
];
?>
			...
			<div class="about-4-list">
				<?php foreach ( $stats as $stat ) : ?>
					<div class="about-4-item">
						<div class="icon flex items-center justify-center w-24 h-24 rounded-full bg-white shadow-md border border-slate-100 mx-auto mb-3">
							<?php echo $stat['svg']; ?>
						</div>
						<div class="caption">
